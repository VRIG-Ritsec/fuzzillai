...
search_knowledge_base_tool = IkaTools(
    ...
    description="Semantic search over V8, JavaScript, and C++ docs. Use for concepts, APIs, or design questions. Filter by topic: v8, javascript, cpp.",
    parameters={
        "query": {"type": "string", "description": "Natural language query about V8, JavaScript, or C++ concepts", "required": True},
        "top_k": {"type": "integer", "description": "Number of results to return (default 3, max 10)", "required": False},
        "topic_filter": {"type": "string", "description": "Optional topic filter: 'v8', 'javascript', 'cpp', or empty for all", "required": False},
    },
...
search_knowledge_base_hybrid_tool = IkaTools(
    ...
    description="Hybrid semantic search (BM25, vector, rerank) for higher recall. Use when search_knowledge_base returns few or weak results.",
    parameters={
        "query": {"type": "string", "description": "Natural language query about V8, JavaScript, or C++ concepts", "required": True},
...
get_knowledge_doc_tool = IkaTools(
    ...
    description="Fetch full document by path from search results. Use file paths returned by search_knowledge_base, not raw source paths.",
    parameters={
